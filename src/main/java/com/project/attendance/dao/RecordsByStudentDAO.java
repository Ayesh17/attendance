...
public class RecordsByStudentDAO {
    ...
    //get by userId
    public List<RecordsByStudent> getByIndexNumber(int indexNumber,String year,int semester){return  recordsByStudentRepository.getRecordsByIndexNumberAndYearAndSemester(indexNumber,year,semester);}
