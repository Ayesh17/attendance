...
public class LecturersCSV {

    public static List<Lecturer> main(Path[] args)
    {
        ...
        HeaderColumnNameTranslateMappingStrategy<Lecturer> strategy =
                new HeaderColumnNameTranslateMappingStrategy<Lecturer>();
        ...
        List<Lecturer> list = csvToBean.parse(strategy, csvReader);
